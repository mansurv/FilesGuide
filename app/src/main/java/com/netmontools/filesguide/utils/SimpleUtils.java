...
import com.netmontools.filesguide.utils.MediaStoreUtils;
...
/**
 * Created by Mansur on 13.05.2016.
 */
public class SimpleUtils {
    ...
    public static void openFile(Context context, final File target) {
        ...
        if (Build.VERSION.SDK_INT < 24) {
            ...
            i.setDataAndType(Uri.parse(target.getPath()), mime);
            // My work-around for new SDKs, doesn't work in Android 10.
        ...
        try {
            ...
            //Toast.makeText(context, context.getString(R.string.cantopenfile) + ": " + e.getMessage(), Toast.LENGTH_SHORT).show();
        }
